        ...
        <div class= "container">
            ...
            while( $pt = mysqli_fetch_object($data) ){
                ...
                echo "<div class='col'>";
                  ...
                  echo "<h5>$pt->NombreCompleto $pt->Celular $pt->CorreoElectronico </h5>";
                  
                   echo "<div class='text-center'>";
                   echo "<a class='btn btn-success' href='".ROOT."/Candidatos/edit.php?id=$pt->id' > Modificar </a> - <a class='btn btn-success' href='".ROOT."/Candidatos/index.php?id=$pt->id'> Eliminar</a>";
                   echo "</div>";
                   echo "</div>";
                   echo "</div>";
